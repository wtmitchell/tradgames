    ...
    public void playGame() {
        ...
        while (true) {
            if (currentPlayer == myPlayer) {
                ...
                currentPlayer = (currentPlayer == Players.player1)
                ...
                if (tokens.length == 6 && tokens[0].equals("MOVE")) {
                    ...
                    if (tokens[1].equals(myName) && tokens[3].equals(opponentName)) {
                        ...
                        System.err.flush();
                    } else if (tokens[3].equals(myName) && tokens[1].equals(opponentName)) {
                        System.err.println("I, " + myName + ", have lost.");
                        System.err.flush();
                    } else {
                        System.err.println("Did not find expected players in FINAL command.");
                        System.err.println("Found '" + tokens[1] + "' and '" + tokens[3] + "'. "
        ...
        while (true) {
            ...
            if (tokens.length == 4 && tokens[0].equals("BEGIN") &&
                ...
                if (tokens[2].equals(myName)) {
                    ...
                    System.err.println("Did not find '" + myName
